...
public class Application02 {
    ...
    public static void main(String[] args) {
        ...
        /* 목표 문자열 객체를 만드는 다양한 방법을 숙지하고 인스턴스가 생성되는 방식 확인 */
        /* 필기
            문자열 객체를 만드는 방법
        ...
        System.out.println("str3 = str4 : " + (str3 == str4));  //필기 변수 값 이랑 원래 값이랑 생각하면 될듯
        ...
        /* 필기
            ...
            == 대신 equalse() 메소드를 사용해야 한다.
         */

        System.out.println("str1.equalse(str3) : " + str1.equals(str3));
    }
}

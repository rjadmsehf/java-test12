...
public class Application01 {
    ...
    public static void main(String[] args) {
       ...
       /* 목표 String 클래스의 자주 사용하는 메소드에 대해 알 수 있다. */
     ...
     */
       ...
       /* 필기
            compareTo() : 인자로 문자열을 전달하여, 같으면 0을 반환, 전달 된 문자열이 작으면 음수
                          크면 양수를 반환한다.
        */
        ...
        System.out.println("compareT0 () : " + (str2.compareTo(str3)));
        System.out.println("compareT0 () : " + (str2.compareTo(str4)));
        System.out.println("compareT0 () : " + (str4.compareTo(str2)));
        System.out.println("compareT0 () : " + (str2.compareTo(str5)));
        ...
        System.out.println("conact() : " + (str2.concat(str5)));
        System.out.println("concat() : " + (str3.concat(str5)));
        ...
        /* 필기. replace() : 문자열에서 대체할 문자열로 기존 문자열을 변경해서 반환, 원본에는 영향XX */

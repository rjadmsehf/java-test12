...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("equase()  : "+ (integerNum1.equals(integerNum2)));
        System.out.println("equase()  : "+ (integerNum1.equals(integerNum3)));
        System.out.println("equase()  : "+ (integerNum3.equals(integerNum4)));
        ...
        System.out.println("valuOf()  : " + (Integer.valueOf(123 ) == Integer.valueOf(123)));

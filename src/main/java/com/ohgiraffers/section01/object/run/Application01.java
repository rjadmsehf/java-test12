...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        /* 목표 Object 클래스의 toString() 메소드 오버라이딩 목적을 이해하고 활용 */
        /* 필기.
            ...
            필기
             ...
             toString(), equals(), hashceod() 이다.
         */

        Book book1 = new Book(1 , "홍길동전 " ,"허균" , 50000);
        Book book2 = new Book(2 , "목민심서 " ,"정약용" , 30000);
        Book book3 = new Book(1 , "홍길동전 " ,"허균" , 30000);


        /* 필기
            toString() 을 호출하지 않고 레퍼런스 변수만 출력하는 경우에도 동이할게 결과가
            나오게 된다.
